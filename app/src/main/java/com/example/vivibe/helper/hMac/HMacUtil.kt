package com.example.vivibe.helper.hMac

import android.os.Build
import androidx.annotation.RequiresApi
import com.example.vivibe.helper.hMac.HexStringUtil.byteArrayToHexString
...
object HMacUtil {
    ...
    fun HMacBase64Encode(algorithm: String, key: String, data: String): String {
        val hMacEncodeBytes = HMacEncode(algorithm, key, data) ?: return ""
